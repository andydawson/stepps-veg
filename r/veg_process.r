...
trace_plots(post_dat, K, suff=suff_fit, save_plots=save_plots, fpath=subDir1)

trace_plots_props(r, suff=suff_fit, save_plots, fpath=subDir1)
rm(r)
...
plot_process_maps(g_mean, centers_pls, taxa, K, thresh=1, suff_fit, save_plots, fpath=subDir1)
plot_process_maps(Halpha_mean, centers_pls, taxa, K, thresh=1, paste(suff_fit, 'Halpha', sep=''), save_plots, fpath=subDir1)

####################################################################################################
# chunk: plot observed proportions
####################################################################################################

plot_data_maps(y, centers_pls, taxa, K, thresh=1, suff_fit, save_plots, fpath=subDir1)
...
plot_data_maps_binned(r_mean, centers_pls, taxa, K, breaks, limits, suff_fit, save_plots, fpath=subDir1)
